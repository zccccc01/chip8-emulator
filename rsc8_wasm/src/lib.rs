...
use rsc8_core::{
    chip8::{Chip8, SCREEN_HEIGHT, SCREEN_WIDTH},
...
pub struct Chip8Wasm {
    chip8: Chip8<LinearCongruentialGenerator>,
...
impl Chip8Wasm {
    ...
    pub fn new() -> Result<Self, JsValue> {
        let rng = LinearCongruentialGenerator::default();
        let chip8 = Chip8::new(rng);
    ...
    pub fn tick(&mut self) {
        let _tick = self.chip8.tick();
    }

    #[wasm_bindgen]
    pub fn tick_timers(&mut self) {
        self.chip8.tick_timer();
    }
